...
const navigationLinks = [
  { href: "/categories", label: "Categories", className: "font-semibold" },
  { href: "/sale", label: "Sale", className: "font-semibold" },
  { href: "/clearance", label: "Clearance", className: "font-semibold" },
  { href: "/new-stock", label: "New stock", className: "font-semibold" },
  { href: "/trending", label: "Trending", className: "font-semibold" },
]
const navigationLinksTop = [
  { href: "/help", label: "Help" },
  { href: "/orders", label: "Order & Return" },
  ...
  return (
    <html lang="en">
      <body className={cn(inter.className, "min-h-screen")}>
        <header className="px-8 py-2 border-b border-border/40 bg-background/95">
          <div className="flex justify-end items-center">
            <NavigationBar links={navigationLinksTop} />
          </div>
          <div className="flex items-center justify-between py-2">
            <h1 className="h2 uppercase">Commerce</h1>
        ...
        <div className="flex bg-muted w-full items-center justify-center py-1.5 gap-2">
          <ChevronLeftIcon />
          <p className="font-medium">Get 10% off on business sign up</p>
          <ChevronRightIcon />
        </div>
        {children}
      </body>
